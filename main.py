...
if __name__ == '__main__':
    ...
    #    root.iconbitmap('d:\\Cloud\\Python\\dh.ico')
    root.resizable(width=False, height=False)

    cConfigValue=get_setting(cConfigFile, "Settings", "InPrice")
    print(f"Risk= {cConfigValue}")
#    InPrice = StringVar(root, value='0.883')
#    TakePrice = StringVar(root, value='0.8708')
#    StopPrice = StringVar(root, value='0.8894')
    ...
    #    LabelOrderVolume=Label(text=nValue, font=("Times", 15, "bold"), fg='#F00')
    LabelOrderVolume = Label(text="", font=("Times", 16, "bold"), fg='#F00')
    LabelOrderVolume.pack()
    #    v = Label(text=nValue, font=("Times", 10, "bold"), fg='#F00')
